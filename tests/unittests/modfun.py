...
class TestModfun(unittest.TestCase):
    ...
    def test_eta(self):
        ...
        self.assertEqual(str(pari.eta('I', precision=127)), '0.99812906992595851327996232224527387813')
    ...
    def test_theta(self):
        self.assertEqual(str(pari.theta('1/2', 'I', precision=127)),
                         '0.E-38 - 0.50432357748832834893222560519660217759*I')

    def test_weber(self):
        self.assertEqual(str(pari.weber('1.0*I', 1, precision=127)), '1.0905077326652576592070106557607079790')
        self.assertEqual(str(pari.weber('1+I', precision=127)),
